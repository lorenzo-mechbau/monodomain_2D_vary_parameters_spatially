...
# Default: n98.xml in same directory
if len(sys.argv) > 1:
...
if len(sys.argv) > 2:
	cellmlModel_fileName = str(sys.argv[2])
else:
	cellmlModel_fileName = "n98.xml"

cellmlModel = os.path.join(file_root_directory, cellmlModel_fileName)
